            ...
            if (collection.length > 0) {
                ...
                return (
                    <NFTBox
                        ...
                        key={search}
                        tokenID={collection[0].token}
                        staker={collection[0].staker}
                    />
                )
        }
    }
        ...
        <div className="gallery__wrapper">
            ...
            <div className="gallery__search">
                <input
                    ...
                    onKeyPress={(item) => keyPresHandler(item)}
                    onChange={(item) => searchHandler(item)}
                    value={search}
                    placeholder="Search"
                    type="search"
                    name="nft-search"
                ...
                />
                <div className="nft-search__items">
