...
export default function StakingReached() {
    ...
    return (
        <div className="staking-reached-container">
            <div className="staking-reached__icon"><img src={smile} alt="" /></div>
            <div className="staking-reached__title">50M Staking Limit is reached!</div>
            <div className="staking-reached__text">Good news that more tokens are coming. Subscribe to get notified.</div>
            <div onClick={() => dispatch(setNotifyForm(true))} className="staking-reached__button">Notify me</div>
        </div>
    )
}
